    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((Button) findViewById(R.id.button)).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                mNfcAdapter = NfcAdapter.getDefaultAdapter(writer.this);
                mNfcPendingIntent = PendingIntent.getActivity(writer.this, 0,
                        new Intent(writer.this, writer.class).addFlags(Intent.FLAG_ACTIVITY_SINGLE_TOP), 0);

                enableTagWriteMode();

                new AlertDialog.Builder(writer.this).setTitle("Touch tag to write")
